...
def parse_commandline_args():
	...
	parser.add_argument('--erpnext-repo-url', dest='erpnext_repo_url', action='store', default='https://github.com/MDALAMIN2526/cpmerp', help='Clone erpnext from the given url')
